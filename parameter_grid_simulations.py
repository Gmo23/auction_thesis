...
ALPHA_GRID = [0.01, 0.05, 0.1, 0.25, 0.5, 1, 1.5, 2]  # order matters (for ID mapping)
# Add 1.5 and 2 to the alpha grid 
            ...
            for trial in range(NUM_TRIALS_PER_COMBO):
                ...
                bidders = [
                    EpsilonGreedy(name="Agent1", value=1, a=0.025, b=0.0002, alpha=0.05,
                                gamma=gamma1, init_param=init_param1, stochastic=0),
                    EpsilonGreedy(name="Agent2", value=1, a=0.025, b=0.0002, alpha=0.05,
                                gamma=gamma2, init_param=init_param2, stochastic=0),
                ]
            ...
            for trial in range(NUM_TRIALS_PER_COMBO):
                ...
                bidders = [
                    EpsilonGreedy(
                        ...
                        gamma=0.99, init_param=1.0/(1.0-0.99), stochastic=0
                    ),
                    EpsilonGreedy(
